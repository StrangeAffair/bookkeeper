...
class QMessageBoxTypingFixed(QtWidgets.QMessageBox):
    ...
    def __init__(self,
                 parent: QWidget,
                 icon: QMessageBox.StandardButton,
                 text: str) -> None:
...
class EditCategoriesWindow(QtWidgets.QDialog):
    ...
    def __init__(self,
        ...
        self.add_btn = QPushButtonWithSignals('Добавить категорию')
        ...
        self.del_btn = QPushButtonWithSignals('Удалить категорию')
...
class MainCategoryWidget(QtWidgets.QWidget):
    ...
    def __init__(self, parent: Union[QtWidgets.QWidget, None] = None):
        ...
        self.btn = QPushButtonWithSignals('Мои категории')
